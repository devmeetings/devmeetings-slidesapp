define(['module', '_', 'slider/slider.plugins', 'ace'], function(module, _, sliderPlugins, ace) {
    ...
    var mapping = {
        ...
        'bekon': ['bekon','becon'],
        'biale_oliwki': ['biale_oliwki','olives'],
        'cebula_2': ['cebula_2','młoda cebula', 'cebulka'],
        'chicoree': ['chicoree','wtf'],
        'czarne_oliwki': ['czarne_oliwki'],
        'frytki': ['frytki','french fries','fries','pommes-frittes'],
        'keczup': ['keczup','ketchup'],
        'kielki': ['kielki','vege'],
        'kotlet_marchewkowy': ['kotlet_marchewkowy','carrot burger','carrotburget','marchewka','karota','karoty','carrots'],
        'kurczak': ['kurczak','chicken'],
        'mozarella': ['mozarella'],
