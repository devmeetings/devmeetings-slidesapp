...
SubForm.prototype.render = function (res) {
    ...
    function renderFields(iFieldSet, prefix, title) {
        ...
        iFieldSet
            .forOwn(
            function forEachFiledInSet(field, field_name) {
                if (field.fields || field instanceof _) {
                    var newPrefix = prefix + field_name + '.';
                    var newTitle = field_name;
                    var fields = (field instanceof _) ? field : _(field.fields);
                    renderFields(fields, newPrefix, newTitle);
                    return;
                }
